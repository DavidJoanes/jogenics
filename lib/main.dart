      ...
      home: Scaffold(
        body: MainWindow(
            backButton: Padding(
              ...
              child: Text('Jogenics Hotel Management System', style: TextStyle(fontFamily: 'Isocpeur', fontWeight: FontWeight.bold, color: navyBlueColor)),
            ), destroyApp: widget.destroyApp, child: Home()),
      ),
    );
  }
}
