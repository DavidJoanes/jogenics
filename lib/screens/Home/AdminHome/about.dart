// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, unused_catch_clause, avoid_print
import 'dart:io';
...
class _AboutState extends State<About> {
  ...
  final String url =
      "https://drive.google.com/drive/folders/1qCC6T_BQpgSg6e64NsXnFKd60szMUBMi?usp=sharing";
      ...
      showDialog(
          ...
          builder: (context) {
            return dialog.ReturnDialog1(
              ...
              message: "Version:  ${db.LatestAppVersion}\nPlease update.",
              color: errorColor,
              buttonText: 'Update',
              onPressed: () async {
                ...
                Row(
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage:
                          AssetImage('assets/icons/JOGENICS.png'),
                    ),
                    SizedBox(width: size.width * 0.3),
                    Text(
                        'Email: jogenics@gmail.com\n\nPhone: +2349032688974',
                        style: TextStyle(
                            fontFamily: 'Biko',
